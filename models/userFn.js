    ...
    if(!errors.isEmpty()){
      ...
      if(usernameCount == 1){
        ...
        if (affectedRows == 1) {
          ...
          fs
            .createReadStream(dir + '/public/images/avatar.jpg')
          ...
          let
            ...
            options = {
              to: email,
              subject: "Activate your SocialNetwork account",
              html: `<span>Hello, You received this message because you created an account on SocialNetwork.<span><br><span>Click on button below to activate your account and explore.</span><br><br><a href='${url}' style='border: 1px solid #1b9be9; font-weight: 600; color: #fff; border-radius: 3px; cursor: pointer; outline: none; background: #1b9be9; padding: 4px 15px; display: inline-block; text-decoration: none;'>Activate</a>`
            }
